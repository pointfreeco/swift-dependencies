  ...
  extension DependencyValues {
    ...
    ///
    /// By default, a "live" generator is supplied, which returns the current system date when
    /// called by invoking `Date.init` under the hood. When used in tests, an "unimplemented"
